...
async function createUser(userData) {
  ...
  // Current schema uses email as PRIMARY KEY (email-first schema)
  // Do NOT include wallet_address - it doesn't exist in the current schema
  const user = {
    email,
  ...
  console.log("🔵 [createUser] Attempting to create user in Supabase:", { email, username: user.username });
  ...
  console.log("✅ [createUser] User created successfully in Supabase:", { email, id: data?.email });
  
  // Also create balance entry for the user (using email as primary key)
  try {
    ...
    if (balanceError) {
      ...
      console.log("✅ [createUser] Balance created successfully for user:", email);
    }
  } catch (balanceError) {
