...
async function getUserByWallet(walletAddress) {
  ...
  const users = loadJSON(path.join(DATA, "users_v2.json"));
...
async function createUserByWallet(walletAddress, userData = {}) {
  ...
  saveJSON(path.join(DATA, "users_v2.json"), users);
...
async function getBalanceByWallet(walletAddress) {
  ...
  const balances = loadJSON(path.join(DATA, "balancs_v2.json"));
...
async function updateBalanceByWallet(walletAddress, updates) {
  ...
  saveJSON(path.join(DATA, "balancs_v2.json"), balances);
...
async function linkWalletToUser(walletAddress, userWalletAddress) {
  ...
  // File-based fallback
  const wallets = loadJSON(path.join(DATA, "wallets_v2.json"));
  ...
  saveJSON(path.join(DATA, "wallets_v2.json"), wallets);
