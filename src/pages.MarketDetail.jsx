          ...
          {(m.imageUrl || m.image_url) && (
            <div className="flex-shrink-0">
              <img 
                ...
                alt={m.question}
                className="w-5 h-5 md:w-6 md:h-6 rounded object-cover border border-gray-700"
                onError={(e) => {
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden">
            ...
            <div className="grid grid-cols-2">
              ...
              <div className="border-r border-gray-800">
                <div className="p-3 bg-green-500/5 border-b border-gray-800">
                ...
                <div className="divide-y divide-gray-800">
                  ...
                  <div className="p-3 space-y-1">
                    ...
                    {orderBook.yes.sell.map((order, i) => (
                      <div key={i} className="flex justify-between text-sm">
                        <span className="text-red-400">{Math.round(order.price * 100)}¢</span>
                        <span className="text-gray-400">{order.shares}</span>
                      </div>
                    ))}
                  </div>
                  {/* Current Price */}
                  ...
                  <div className="p-3 space-y-1">
                    ...
                    {orderBook.yes.buy.map((order, i) => (
                      <div key={i} className="flex justify-between text-sm">
                        <span className="text-green-400">{Math.round(order.price * 100)}¢</span>
                        <span className="text-gray-400">{order.shares}</span>
                      </div>
                    ))}
                  </div>
              ...
              {/* NO Order Book */}
              <div>
                <div className="p-3 bg-red-500/5 border-b border-gray-800">
