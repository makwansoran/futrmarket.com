...
export default function SubjectsNav() {
  ...
  if (loading) {
    ...
    return (
      <nav id="subjects-nav" className="sticky z-20 border-b border-white/10 bg-gray-950/70 backdrop-blur supports-[backdrop-filter]:bg-gray-950/50" style={{ zIndex: 20, top: '100px' }}>
