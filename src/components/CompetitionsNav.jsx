...
export default function CompetitionsNav() {
  ...
  if (loading) {
    ...
    return (
      <nav id="competitions-nav" className="sticky z-10 border-b border-white/10 bg-gray-950/70 backdrop-blur supports-[backdrop-filter]:bg-gray-950/50" style={{ display: 'block', visibility: 'visible', top: '144px' }}>
