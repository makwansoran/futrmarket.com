...
export default function CategoryNav() {
  ...
  return (
    <nav id="category-nav" className="sticky z-30 border-b border-white/10 bg-gray-950/70 backdrop-blur supports-[backdrop-filter]:bg-gray-950/50" style={{ zIndex: 30, top: '56px', position: 'sticky' }}>
